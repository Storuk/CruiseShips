                    ...
                    <div class="card-body p-md-5">
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                ...
                                <form action="<%= request.getContextPath() %>/admin" method="post" class="mx-1 mx-md-4">

                                    <div class="d-flex flex-row align-items-center mb-4">
                                        <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                                        <div class="form-outline flex-fill mb-0">
                                            <input type="text" name = "adminname" required = "required" placeholder="<fmt:message key="lable.login"/>" id="form3Example1c" class="form-control" />
...
<script type="text/javascript">
    ...
    if(status == "no_admin"){
        swal("Sorry", "You aren't admin", "error");
    }
    else if(status == "invalid_log_or_pass"){
